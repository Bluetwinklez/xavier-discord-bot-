...
<!-- Kısaca ne değiştirdiğini ve neden anlat -->

## Nasıl test ettin?

- [ ] `npm test` geçti
- [ ] `node --check <değiştirdiğim dosyalar>` ile syntax doğrulandı
- [ ] Botu gerçekten çalıştırıp ilgili komutu/özelliği elle denedim
